...
class Cmonkey(object):
    ...
    def build_cmonkey_network(self, series, params):
        ...
        arg_hash = {'method': 'Cmonkey.build_cmonkey_network',
    ...
    def build_cmonkey_network_from_ws(self, ws_id, collection_id, params):
        ...
        arg_hash = {'method': 'Cmonkey.build_cmonkey_network_from_ws',
                    'params': [ws_id, collection_id, params],
                    'version': '1.1',
                    'id': str(random.random())[2:]
                    }
    ...
    def build_cmonkey_network_job_from_ws(self, ws_id, series_id, params):
        ...
        arg_hash = {'method': 'Cmonkey.build_cmonkey_network_job_from_ws',
                    'params': [ws_id, series_id, params],
                    'version': '1.1',
                    'id': str(random.random())[2:]
                    }
