...
/**
 * <p>Original spec-file type: object_history_params</p>
 * <pre>
...
public class ObjectHistoryParams {
    ...
    public ObjectHistoryParams withAsHash(Long asHash) {
        this.asHash = asHash;
        return this;
    }
    ...
    public String toString() {
        return ((((((((((((("ObjectHistoryParams"+" [id=")+ id)+", type=")+ type)+", workspace=")+ workspace)+", auth=")+ auth)+", asHash=")+ asHash)+", additionalProperties=")+ additionalProperties)+"]");
    }
