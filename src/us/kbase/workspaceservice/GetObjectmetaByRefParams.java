...
/**
 * <p>Original spec-file type: get_objectmeta_by_ref_params</p>
 * <pre>
...
public class GetObjectmetaByRefParams {
    ...
    public GetObjectmetaByRefParams withAsHash(Long asHash) {
        this.asHash = asHash;
        return this;
    }
    ...
    public String toString() {
        return ((((((((("GetObjectmetaByRefParams"+" [reference=")+ reference)+", auth=")+ auth)+", asHash=")+ asHash)+", additionalProperties=")+ additionalProperties)+"]");
    }
