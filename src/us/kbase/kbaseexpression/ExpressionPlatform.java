...
public class ExpressionPlatform {
    ...
    public ExpressionPlatform withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public String toString() {
        return ((((((((((((((("ExpressionPlatform"+" [id=")+ id)+", sourceId=")+ sourceId)+", genomeId=")+ genomeId)+", strain=")+ strain)+", technology=")+ technology)+", title=")+ title)+", additionalProperties=")+ additionalProperties)+"]");
    }
