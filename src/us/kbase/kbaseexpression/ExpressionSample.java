...
public class ExpressionSample {
    ...
    public ExpressionSample withId(java.lang.String id) {
        this.id = id;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((((((((((((((((((((((((((((((((((((((((("ExpressionSample"+" [id=")+ id)+", sourceId=")+ sourceId)+", type=")+ type)+", numericalInterpretation=")+ numericalInterpretation)+", description=")+ description)+", title=")+ title)+", dataQualityLevel=")+ dataQualityLevel)+", originalMedian=")+ originalMedian)+", externalSourceDate=")+ externalSourceDate)+", expressionLevels=")+ expressionLevels)+", genomeId=")+ genomeId)+", expressionOntologyTerms=")+ expressionOntologyTerms)+", platformId=")+ platformId)+", defaultControlSample=")+ defaultControlSample)+", averagedFromSamples=")+ averagedFromSamples)+", protocol=")+ protocol)+", strain=")+ strain)+", persons=")+ persons)+", molecule=")+ molecule)+", dataSource=")+ dataSource)+", additionalProperties=")+ additionalProperties)+"]");
    }
