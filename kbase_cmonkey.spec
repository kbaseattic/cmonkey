...
module Cmonkey
{
	...
	*/
	...
	/* Represents motif generated by cMonkey with a list of hits in upstream sequences
		cmonkey_motif_id id - identifier of MotifCmonkey
	...
	*/
	typedef structure{
		string id;
		float residual;
		list<expression_sample_ws_id> sample_ws_ids;
		list<gene_id> gene_ids;
		list<CmonkeyMotif> motifs;
	} CmonkeyCluster;
	
	/* Represents network generated by a single run of cMonkey
		cmonkey_network_id id - identifier of cMonkey-generated network
	...
	*/
	...
	/* Contains parameters of a cMonkey run
		...
		@optional genome_id operome_id network_id
	*/
	typedef structure{
		expression_series_ws_id series_id;
		genome_ws_id genome_id;
		operome_ws_id operome_id;
		network_ws_id network_id;
		int networks_scoring;
		int motifs_scoring;
	} CmonkeyRunParameters;

	/* Represents data from a single run of cMonkey
		cmonkey_run_result_id id - identifier of cMonkey run
	...
	*/
	funcdef build_cmonkey_network_job_from_ws(string ws_id, CmonkeyRunParameters params) returns(string cmonkey_run_result_job_id) authentication required;
};
